...
point_cloud_range = [-30.0, -60.0, -2.0, 30.0, 60.0, 2.0]
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        bbox_coder=dict(
            ...
            post_center_range=[-61.2, -61.2, -61.2, -61.2, 61.2, 61.2, 61.2, 61.2],
...
data = dict(
    ...
    val=dict(type=dataset_type,
             ...
             map_ann_file=data_root + 'nuscenes_map_anns_val_60x120.json',
